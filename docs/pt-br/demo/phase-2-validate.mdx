...
A Fase 2 confirma que a zona da [Fase 1](/dns/pt-br/demo/phase-1-build/) está ativa: os registros resolvem publicamente,
...
Continue para a [Fase 3 — Failover](/dns/pt-br/demo/phase-3-failover/).
