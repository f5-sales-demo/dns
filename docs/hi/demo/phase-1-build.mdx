...
एक सफल अप्लाई ज़ोन बनाता है और स्टेट को Azure कंटेनर में लिखता है। यह पुष्टि करने के लिए कि यह रिज़ॉल्व होता है, [चरण 2 — वैलिडेट](/dns/demo/phase-2-validate/) पर जाएं।
