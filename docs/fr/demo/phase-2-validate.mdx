...
La Phase 2 confirme que la zone créée lors de la [Phase 1](/dns/demo/phase-1-build/) est active : les enregistrements se résolvent publiquement,
...
Poursuivez vers la [Phase 3 — Basculement](/dns/demo/phase-3-failover/).
